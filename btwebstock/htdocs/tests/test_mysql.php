...
$_sql = "insert into tab_test(code, description, value) values (1, 'testdesc', 1.55)";
if($_db->executeSQL($_sql) !== false) {
	echo "1st register inserted.<br>";
}

$_sql = "insert into tab_test(code, description, value) values (2, 'testdesc1', 11.65)";
if($_db->executeSQL($_sql) !== false) {
	echo "2nd register inserted.<br>";
}

$_sql = "insert into tab_test(code, description, value) values (3, 'testdesc2', 81.45)";
if($_db->executeSQL($_sql) !== false) {
